...
namespace :vlad do
  ...
  remote_task :start_app, :roles => nil do
    # puts "Nothing to do to restart the application server"
  end

  desc "Stop the application servers"
  remote_task :stop_app, :roles => nil do
    # puts "Nothing to do to stop the application server"
  end

  namespace :start_app do
    desc "Start the applicaiton servers for the first time"
    remote_task :first_time, :role => nil do
